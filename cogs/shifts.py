...
CONFIG = {
    ...
    "ad": {
        "role_id": 888888888888888888,        # НАСТРОЙКА: Роль сотрудников AD и 24AD (ОДИНАКОВАЯ)
        "curator_role_id": 555666777888999,   # НАСТРОЙКА: Роль кураторов AD и 24AD (ОДИНАКОВАЯ)
        "slots": [
    ...
    "24ad": {
        "role_id": 888888888888888888,        # НАСТРОЙКА: Дублируем ту же роль, что и в AD
        "curator_role_id": 555666777888999,   # НАСТРОЙКА: Дублируем ту же роль куратора, что и в AD
        "slots": [
